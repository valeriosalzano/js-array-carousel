...
prevArrow.addEventListener('click',
    function(){
        sliderContent[current].classList.remove("go-up","go-down");
        ...
        sliderContent[current].classList.add("showed","go-down");
        thumbnailsContent[current].classList.add("highlight");
    }
)
...
nextArrow.addEventListener('click',
    function(){
        ...
        sliderContent[current].classList.add("showed","go-up");
        thumbnailsContent[current].classList.add("highlight");
    }
)